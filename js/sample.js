...
let k = 0; //待ち人数
let M=10;
let ALF=slider3.slider_value;
let DEL=slider1.slider_value;
let SIG=slider2.slider_value;
...
function poison(){
    ...
    taw = -log(Math.random()/Math.random()+EPS)/ALF;
    return taw;
}